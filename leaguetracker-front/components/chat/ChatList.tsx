                    ...
                    <div className="flex-1 min-w-0 overflow-hidden"> 
                      <div className="flex justify-between items-center w-full">
                        <div className="flex items-center">
                          <span className={`font-medium truncate ${isActive ? 'text-white' : 'text-gray-300'}`}>{friend}</span>
                          {/* Indicador de mensajes no leídos */}
                          {unreadMessages[friend] > 0 && (
                            <span className="ml-2 bg-blue-500 text-white text-xs font-medium rounded-full px-1.5 py-0.5 min-w-[1.25rem] text-center">
