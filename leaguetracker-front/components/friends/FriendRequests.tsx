  ...
  const renderEmptyState = (type: 'incoming' | 'outgoing') => (
    <div className="flex flex-col items-center justify-center p-4 text-center h-48">
      <div className="text-muted-foreground mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-10 h-10 mx-auto mb-2">
        ...
        {incomingRequests.map((request, index) => (
          <div key={index} className="bg-secondary/10 rounded-md p-3 mb-2">
            <div className="flex items-center mb-2">
              <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center text-lg font-medium mr-3">
