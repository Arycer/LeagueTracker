    ...
    <Card className="bg-[#1e293b]/70 border-blue-900/30 w-full max-w-2xl mx-auto">
      <CardContent className="p-6 space-y-6">
        ...
        <div className="text-sm text-gray-400 border-t border-blue-900/30 pt-4">
          <p>Estos componentes utilizan el contexto DDragon para obtener automáticamente la versión más
            reciente del parche.</p>
          <p>Puedes usarlos en toda la aplicación importándolos desde <code
            className="text-blue-300">@/components/ddragon</code></p>
        </div>
      </CardContent>
    </Card>
  );
