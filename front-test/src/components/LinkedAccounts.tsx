                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <div
                                            className="w-12 h-12 rounded-full overflow-hidden border-2 border-blue-400 bg-white flex-shrink-0">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-xs text-blue-600 mt-1">Icono requerido para verificar
                                            </div>
                                            ...
                                            {pendingState.verificationResult === 'error' && (
                                                <div
                                                    className="text-red-600 text-xs mt-1">{pendingState.errorMsg || 'Error al verificar'}</div>
                                            )}
                                        </div>
                                    </div>
                                ...
                                >
                                    <div>
                                        <div className="font-medium flex items-center gap-2">
                                            ...
                                            {isMain && (
                                                <span
                                                    className="inline-block px-2 py-0.5 text-xs bg-blue-500 text-white rounded">Principal</span>
                                            )}
                                        </div>
